        ...
        <div className={Homestyle.scroll}> {/*ปรับให้หน้า Home มี scroll bar ให้ทำโค้ดภายใน div นี้*/}
            ...
            <p>
                ...
                <div className={Homestyle.flexColumn} style={{display: 'inline-block'}}>
                    <div><img src={featured01} style={{paddingLeft: '15.5vw'}}
                              alt={"Design Character with your head"}></img></div>
                    <div className={Homestyle.myfont} style={{paddingLeft: '15.5vw', color: 'white'}}>Design character
                        with your hand
                    </div>
                </div>
                <div className={Homestyle.flexColumn} style={{display: 'inline-block'}}>
                    <div><img src={featured02} style={{paddingLeft: '15.5vw'}}
                              alt={"Design Character with your head"}></img></div>
                ...
                <div className={Homestyle.flexColumn} style={{display: 'inline-block'}}>
                    <div><img src={featured03} style={{paddingLeft: '15.5vw'}}
                              alt={"Design Character with your head"}></img></div>
            ...
            <p>
                <div className={Homestyle.flexColumn} style={{display: 'inline-block'}}>
                    <div><img src={featured04} style={{paddingLeft: '30vw'}}
                              alt={"Design Character with your head"}></img></div>
                ...
                <div className={Homestyle.flexColumn} style={{display: 'inline-block'}}>
                    <div><img src={featured05} style={{paddingLeft: '15.5vw'}}
                              alt={"Design Character with your head"}></img></div>
